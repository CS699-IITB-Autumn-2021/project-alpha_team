...
class Block:
    ...
    def addBlock(self,secret_code,name_of_blockchain,voter_id,vote_given):
        ...
        if index==-1:
            ...
            prev_hash=file_data[index+7:index+71]

        my_hash = hashlib.sha256(str( str(secret_code)+str(voter_id)+"vote:"+str(vote_given)+prev_hash).encode('utf-8')).hexdigest()
        ...
        return "my_hash:"+my_hash+"prev_hash:"+prev_hash

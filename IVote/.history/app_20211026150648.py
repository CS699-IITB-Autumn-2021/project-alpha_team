...
def Vote():
    if request.method=="POST":
        ...
        conn = sqlite3.connect("ivote.db")
        c = conn.cursor()
        c.execute("CREATE TABLE IF NOT EXISTS election"++"(secret_code TEXT ,name_of_blockchain TEXT,voter_id TEXT,vote_given TEXT)")
        r1 = random.randint(0, 100000)

    return render_template('voter.html',r1=r1) 
